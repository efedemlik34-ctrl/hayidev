...
class GamesScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> luckyGames = const [
    ...
    {'key': 'slot',           'name': 'Slot',                'img': 'assets/games/game_icons/slot.png'},
    {'key': 'bingo',          'name': 'Bingo',               'img': 'assets/games/game_icons/bingo.png'},
  ];
  ...
  void _open(BuildContext ctx, String key) {
    switch (key) {
      ...
      case 'slot':         Navigator.pushNamed(ctx, '/slot'); break;
      default:
        // Slot temalar
